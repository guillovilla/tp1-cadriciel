    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('document.index')->with('success', trans('lang.document_created_successfully'));
    ...
    public function update(Request $request, Document $document)
    {
        ...
        return redirect()->route('document.index')->with('success', trans('messages.document_updated_successfully'));
    ...
    {
        $document->delete();
        return redirect()->route('document.index')->with('success', trans('messages.document_deleted_successfully'));
