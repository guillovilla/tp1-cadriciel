                ...
                <div class="card-body">
                    <form  method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="texte_fr" name="texte_fr" value="{{old('texte_fr')}}"></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="texte_en" name="texte_en" value="{{old('texte_en')}}"></textarea>
                        </div>
