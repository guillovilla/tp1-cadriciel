                ...
                <div class="card-body">
                    <form  method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nom_fr" name="nom_fr" value="{{ $document->nom['fr'] }}">
                        </div>

                        <div class="mb-3">
                            <label for="nom_en" class="form-label">Name in English</label>
                            <input type="text" class="form-control" id="nom_en" name="nom_en" value="{{ $document->nom['en'] }}">
                        </div>
