...
@section('content')
    <h1 class="my-5"> @lang('lang.text_liste')</h1>
        <div class="container">
            <div class="main-body">
            ...
            @foreach($etudiants as $etudiant)
                    <div class="col mb-3">
                        <div class="card">
                            ...
                            <p class="text-muted font-size-sm">{{ $etudiant->user->email }}</p>
                            </div>
                            <div class="card-footer">
                                <div class="d-flex justify-content-end">
                                    <a href="{{route('etudiant.show', $etudiant->id)}}" class="btn btn-sm btn-outline-primary">@lang('lang.text_boutton_voir')</a>
                                </div>
                            </div>
