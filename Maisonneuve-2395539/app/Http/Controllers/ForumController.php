    ...
    public function update(Request $request, Forum $forum)
{
    ...
    return redirect()->route('forum.index')->with('success', 'Article updated successfully!');
}
    ...
    {
        $forum->delete();
        return redirect()->route('forum.index')->with('success', 'Article deleted successfully!');
    }
}
